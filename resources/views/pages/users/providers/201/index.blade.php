        ...
        <div class="card card-4">
            <div class="card-body">
                ...
                <form action="pages.users.providers.201.store" method="POST">
                    ...
                    <div class="p-b-15"></div>
                    <div class="questions">Add your offer's portrait. This is what the clients will see first and thus
                        should be the best photo you have:
                        <div class="p-b-15"></div>
                    ...
                    <div class="questions">What does it cost? Please note that we will deduct a 2% fee to this cost as
                        per our agreement. To check more, please refer to Terms & Conditions.
                        <div class="p-b-15"></div>
