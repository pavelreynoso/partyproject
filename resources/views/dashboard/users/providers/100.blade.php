                ...
                <form method="POST">
                    ...
                    <div class="questions">Para empezar, indica que ofreces:</div>
                        <select class="select_register_medium" name="article type">
                            <option value ="product"><h6>Producto</h6></option>
                    ...
                    <div class="questions">Ahora, selecciona para que tipos de eventos ofreces tus productos/servicios </div>
                    
                    <div class="p-b-15"></div>
                    <div class="questions">¿En que categoría entra lo que ofreces?</div>
                    <select name="services" id="servicesSelect" class="select_register_medium">
